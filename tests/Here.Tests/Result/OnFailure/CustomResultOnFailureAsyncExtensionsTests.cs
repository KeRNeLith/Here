...
namespace Here.Tests.Results
{
    ...
    internal class CustomResultOnFailureAsyncExtensionsTests : ResultTestsBase
    {
        ...
        public async Task CustomResultOnFailureAsync()
        {
            ...
            Assert.ThrowsAsync<ArgumentNullException>(() => ok.OnFailureAsync((Func<CustomResult<CustomErrorTest>, Task<string>>)null, () => Task.FromResult("Default")));
            ...
            Assert.ThrowsAsync<ArgumentNullException>(() => ok.OnFailureAsync((Func<CustomResult<CustomErrorTest>, Task<string>>)null, (Func<Task<string>>)null));
        ...
        public async Task TaskCustomResultOnFailureAsyncValue()
        {
            ...
            Assert.ThrowsAsync<ArgumentNullException>(() => ((Task<CustomResult<CustomErrorTest>>)null).OnFailureAsync(r => "Never returned", () => "Never returned"));
            Assert.ThrowsAsync<ArgumentNullException>(() => taskResult.OnFailureAsync((Func<CustomResult<CustomErrorTest>, string>)null, () => Task.FromResult("Default value")));
            Assert.ThrowsAsync<ArgumentNullException>(() => taskResult.OnFailureAsync(r => "Never returned", (Func<Task<string>>)null));
            Assert.ThrowsAsync<ArgumentNullException>(() => taskResult.OnFailureAsync((Func<CustomResult<CustomErrorTest>, string>)null, (Func<Task<string>>)null));
            Assert.ThrowsAsync<ArgumentNullException>(() => ((Task<CustomResult<CustomErrorTest>>)null).OnFailureAsync(r => "Never returned", () => Task.FromResult("Never returned")));
            // ReSharper restore AssignNullToNotNullAttribute
        }
        ...
        public async Task TaskCustomResultOnFailureAsyncTaskValue()
        {
            ...
            Assert.ThrowsAsync<ArgumentNullException>(() => ((Task<CustomResult<CustomErrorTest>>)null).OnFailureAsync(r => Task.FromResult("Never returned"), () => "Never returned"));
            Assert.ThrowsAsync<ArgumentNullException>(() => taskResult.OnFailureAsync((Func<CustomResult<CustomErrorTest>, Task<string>>)null, () => Task.FromResult("Default value")));
            ...
            Assert.ThrowsAsync<ArgumentNullException>(() => taskResult.OnFailureAsync((Func<CustomResult<CustomErrorTest>, Task<string>>)null, (Func<Task<string>>)null));
            Assert.ThrowsAsync<ArgumentNullException>(() => ((Task<CustomResult<CustomErrorTest>>)null).OnFailureAsync(r => Task.FromResult("Never returned"), () => Task.FromResult("Never returned")));
            // ReSharper restore AssignNullToNotNullAttribute
        }
    }
}
