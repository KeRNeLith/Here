...
{
    /// <summary>
    /// Tests for <see cref="Result"/> asynchronous extensions (on failure).
    /// </summary>
    [TestFixture]
    internal class ResultOnFailureAsyncExtensionsTests : ResultTestsBase
    {
        ...
        public async Task ResultOnFailureAsync()
        {
            ...
            Assert.ThrowsAsync<ArgumentNullException>(() => ok.OnFailureAsync((Func<Result, Task<string>>)null, () => Task.FromResult("Default")));
            ...
            Assert.ThrowsAsync<ArgumentNullException>(() => ok.OnFailureAsync((Func<Result, Task<string>>)null, (Func<Task<string>>)null));
        ...
        public async Task TaskResultOnFailureAsyncValue()
        {
            ...
            Assert.ThrowsAsync<ArgumentNullException>(() => ((Task<Result>)null).OnFailureAsync(r => "Never returned", () => "Never returned"));
            Assert.ThrowsAsync<ArgumentNullException>(() => taskResult.OnFailureAsync((Func<Result, string>)null, () => Task.FromResult("Default value")));
            Assert.ThrowsAsync<ArgumentNullException>(() => taskResult.OnFailureAsync(r => "Never returned", (Func<Task<string>>)null));
            Assert.ThrowsAsync<ArgumentNullException>(() => taskResult.OnFailureAsync((Func<Result, string>)null, (Func<Task<string>>)null));
            Assert.ThrowsAsync<ArgumentNullException>(() => ((Task<Result>)null).OnFailureAsync(r => "Never returned", () => Task.FromResult("Never returned")));
            // ReSharper restore AssignNullToNotNullAttribute
        }
        ...
        public async Task TaskResultOnFailureAsyncTaskValue()
        {
            ...
            Assert.ThrowsAsync<ArgumentNullException>(() => ((Task<Result>)null).OnFailureAsync(r => Task.FromResult("Never returned"), () => "Never returned"));
            Assert.ThrowsAsync<ArgumentNullException>(() => taskResult.OnFailureAsync((Func<Result, Task<string>>)null, () => Task.FromResult("Default value")));
            ...
            Assert.ThrowsAsync<ArgumentNullException>(() => taskResult.OnFailureAsync((Func<Result, Task<string>>)null, (Func<Task<string>>)null));
            Assert.ThrowsAsync<ArgumentNullException>(() => ((Task<Result>)null).OnFailureAsync(r => Task.FromResult("Never returned"), () => Task.FromResult("Never returned")));
            // ReSharper restore AssignNullToNotNullAttribute
        }
    }
}
