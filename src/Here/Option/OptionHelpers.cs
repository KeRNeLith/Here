...
namespace Here
{
    ...
    public static class OptionHelpers
    {
        ...
        [PublicAPI, Pure]
        public static bool AreEqual<T>(Option<T> option1, Option<T> option2, [CanBeNull] IEqualityComparer<T> equalityComparer = null)
        {
        ...
        [PublicAPI, Pure]
        public static bool AreEqual<T>(Option<T> option, [CanBeNull] T value, [CanBeNull] IEqualityComparer<T> equalityComparer = null)
        {
        ...
        [PublicAPI, Pure]
        public static int Compare<T>(Option<T> option1, Option<T> option2, [CanBeNull] IComparer<T> comparer = null)
        {
