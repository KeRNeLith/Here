...
namespace Here.Extensions
{
    ...
    public static class EitherLinqExtensions
    {
        ...
        [PublicAPI, Pure]
        public static bool Any<TLeft, TRight>(in this Either<TLeft, TRight> either)
        {
...
#endif
        public static bool All<TLeft, TRight>(in this Either<TLeft, TRight> either, [NotNull, InstantHandle] in Predicate<TRight> predicate)
        {
        ...
        [PublicAPI, Pure]
        public static bool Contains<TLeft, TRight>(in this Either<TLeft, TRight> either, [CanBeNull] in TRight value)
        {
        ...
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
#endif
        public static Either<TLeft, TRightOut> Select<TLeft, TRight, TRightOut>(in this Either<TLeft, TRight> either, [NotNull, InstantHandle] in Func<TRight, TRightOut> selector)
        {
        ...
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
#endif
        public static Unit ForEach<TLeft, TRight>(in this Either<TLeft, TRight> either, [NotNull, InstantHandle] in Action<TRight> doAction)
        {
        ...
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
#endif
        public static TAggregate Aggregate<TLeft, TRight, TAggregate>(in this Either<TLeft, TRight> either,
            [NotNull] in TAggregate initialValue,
            [NotNull, InstantHandle] in Func<TAggregate, TRight, TAggregate> aggregator)
        {
